...
public class Vino implements conDescuento, esLiquido, esAlimento {
	...
	public void setGrados(double grados) {this.grados = grados;	}
	...
	@Override
	public double getPrecioDescuento() {return this.precio*(1-(this.descuento/100));}
	@Override
	public void setCaducidad(LocalDate fc) {this.caducidad=fc;	}
	@Override
	public LocalDate getCaducidad() {return this.caducidad;	}
	@Override
	public int getCalorias() {return (int)(this.grados*10);}
	@Override
